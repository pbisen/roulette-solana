...
//added the secret key i used while doing the quest
const userSecretKey = new Uint8Array( [
  40, 123,  66,  70,  82,  13, 172, 255, 151, 238,  25,
 121, 123,  27, 105, 203, 203, 184, 255, 114,  79, 129,
   4,  99, 135, 186, 136, 234,  51,   7, 151, 198,  76,
 151,  23, 205, 143, 194, 225, 157, 210, 136,  22, 215,
 235, 203, 153, 227, 222, 213, 157, 130, 106,   3, 214,
  65, 167, 118, 113,   9, 155,  39, 153,  41
]);

const userWallet=Keypair.fromSecretKey(Uint8Array.from(userSecretKey));


//Treasury: Using the one in the code already
const secretKey=[
